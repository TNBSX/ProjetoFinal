...
bola = Bolinha_assassina("bola-menor.png", 250, 500, velb)
bola_group.add(bola)

bola2 = Bolinha_assassina("bola-menor.png", 325, 100, -velb)
bola_group.add(bola2)

bola3 = Bolinha_assassina("bola-menor.png", 400, 500, velb)
bola_group.add(bola3)

bola4 = Bolinha_assassina("bola-menor.png", 475, 100, -velb)
bola_group.add(bola4)

bola5 = Bolinha_assassina("bola-menor.png", 550, 100, velb)
bola_group.add(bola5)

bola6 = Bolinha_assassina("bola-menor.png", 625, 100, -velb)
bola_group.add(bola6)

bolaP_group = pygame.sprite.Group()

# cir a bola que pega para ganhar o jogo
bolaP1 = Bolaquepega("amarelo-pega.png", 430 , 200)
...
#move a bolinha
  ...
  bola5.move3()
  if bola5.rect.y < 10 or bola5.rect.y > 575:
      bola5.vy = -bola5.vy
  ...
  if contador == 1 and pygame.sprite.collide_rect(quadrado,zona):
      pygame.quit()
